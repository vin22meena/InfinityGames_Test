...
/// <summary>
/// StraightLineNode.cs Class, Inherited from Node class and Performs Specific Operation according to StraightLine Node.
/// </summary>

namespace LoopEnergyClone
{
    public class StraightLineNode : Node, IHighlightable
    {
