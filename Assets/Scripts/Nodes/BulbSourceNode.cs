...
/// <summary>
/// BulbSourceNode.cs Class, Inherited from Node class and Performs Specific Operation according to BulbSource Node.
/// </summary>

namespace LoopEnergyClone
{
    public class BulbSourceNode : Node, IHighlightable
    {
